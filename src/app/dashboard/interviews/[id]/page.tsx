...
export default function InterviewDetailPage({
  ...
  return (
    <div className="min-h-screen bg-(--bg-mist) text-(--text-primary) flex flex-col relative pb-16 print:bg-white print:text-black">
      ...
      {/* Header */}
      <header className="w-full max-w-400 mx-auto px-6 md:px-10 py-6 flex justify-between items-center relative z-20 no-print">
        <button
      ...
      <main className="w-full max-w-400 mx-auto px-6 md:px-10 pt-4 flex flex-col gap-6 relative z-20 print:pt-0 select-none">
      ...
      {/* Footer */}
      <footer className="w-full max-w-400 mx-auto px-6 md:px-10 pt-16 text-center text-xs text-slate-400 mt-auto select-none flex justify-between items-center border-t border-slate-100 no-print">
