    ...
    <div className="min-h-screen bg-(--bg-mist) text-(--text-primary) flex flex-col pt-20">
      ...
      <section className="w-full max-w-6xl mx-auto px-6 pt-16 relative z-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto items-stretch">
          ...
          {/* Free Trial */}
          <div className="bg-white border border-(--border-light) rounded-[12px] p-8 flex flex-col justify-between shadow-sm min-h-[420px] transition hover:shadow-md">
            <div>
          ...
          {/* Pro Pass Card */}
          <div className="bg-white border border-(--accent)/30 rounded-[12px] p-8 flex flex-col justify-between shadow-md relative min-h-[420px] z-10 transition hover:shadow-lg">
      ...
      <section className="w-full max-w-5xl mx-auto px-6 pt-24 pb-8 relative z-20 select-none" id="referrals-section">
        <div className="bg-white border border-(--border-light) rounded-[12px] p-6 md:p-8 flex flex-col gap-6 shadow-sm">
          ...
          <div className="bg-gradient-to-r from-purple-500/5 to-sky-500/5 border border-slate-200 rounded-[12px] p-5 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[11px] text-(--text-muted)">Sign in to your dashboard to access and share your unique invite code.</p>
            </div>
            <a
              href="/login"
