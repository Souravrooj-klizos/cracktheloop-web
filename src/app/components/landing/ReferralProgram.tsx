...
export default function ReferralProgram() {
  ...
  return (
    <section
      id="referral-program"
      className="section-mist relative py-14 md:py-16 overflow-hidden select-none"
    >
      {/* Decorative Orbs */}
      <div className="orb orb-peach w-125 h-125 -top-20 -left-20 opacity-45 pointer-events-none animate-float-orb" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        ...
        <ScrollReveal>
          <div className="text-center mb-8 flex flex-col items-center">
            ...
            >
              Spread the Word.{" "}
              <span className="text-gradient-coral">Earn Free Credits</span>.
            </h2>
            <p className="text-(--text-muted) text-base max-w-xl mt-3 leading-relaxed">
              Invite your network to CrackTheLoop. Our two-sided referral
              program rewards both of you the moment they register.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-7xl mx-auto mb-6">
            ...
            <div className="bg-white/85 backdrop-blur-md border border-(--border-light) rounded-xl p-6 md:p-8 flex flex-col justify-between shadow-xs hover:border-(--accent)/40 hover:-translate-y-1 hover:shadow-sm transition-all duration-300">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <span className="text-[9px] font-bold tracking-wider text-(--accent) uppercase font-mono">
                      Invited Guest
                    </span>
                    <h3
                ...
                <p className="text-sm md:text-base text-slate-650 leading-relaxed font-semibold">
                  When someone registers using your invitation link, they get{" "}
            ...
            <div className="bg-white/85 backdrop-blur-md border border-(--border-light) rounded-xl p-6 md:p-8 flex flex-col justify-between shadow-xs hover:border-(--accent)/40 hover:-translate-y-1 hover:shadow-sm transition-all duration-300">
              <div>
                ...
                <p className="text-sm md:text-base text-slate-650 leading-relaxed font-semibold">
                  Every time a referred colleague signs up and activates their
                  trial, you instantly receive{" "}
                  <span className="text-(--accent) font-bold">
                    +50 free credits
                  </span>{" "}
        ...
        <ScrollReveal>
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/70 backdrop-blur-md border border-(--border-light) rounded-xl p-6 md:p-8 shadow-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                ...
                <div className="hidden md:block absolute top-7 left-[15%] right-[15%] h-px bg-slate-200 -z-10" />
                ...
                {steps.map((step) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h4 className="text-sm md:text-base font-bold text-(--text-primary) mb-2">
                        {step.title}
                      </h4>
                      <p className="text-xs md:text-sm text-(--text-muted) leading-relaxed max-w-60 font-medium">
                        {step.desc}
                      </p>
                    </div>
                  );
