...
const companyList = [
  ...
  {
    name: "Zoho",
    src: "https://upload.wikimedia.org/wikipedia/commons/f/f2/ZOHO.svg",
  },
  ...
  { name: "Tesla", src: "/images/landing-logo-tesla.webp" },
  {
    ...
    showText: true,
    textClass:
      "font-semibold tracking-tight text-slate-800 text-sm md:text-base ml-1.5",
  },
  ...
  { name: "Pinterest", src: "https://cdn.svgporn.com/logos/pinterest.svg" },
  {
    ...
    showText: true,
    textClass:
      "font-bold tracking-tight text-[#0A66C2] text-sm md:text-base ml-1",
  },
  ...
  { name: "Adobe", src: "https://cdn.svgporn.com/logos/adobe.svg" },
  {
    ...
    showText: true,
    textClass:
      "font-bold tracking-tight text-slate-800 text-sm md:text-base ml-1",
  },
  {
    name: "Figma",
    ...
    showText: true,
    textClass:
      "font-bold tracking-tight text-slate-800 text-sm md:text-base ml-1.5",
  },
];
  ...
  const simulatorQuestions = [
    {
      ...
      icon: Users,
      question:
        "Tell me about a time you disagreed with a PM on scope or timeline. How did you resolve it?",
      answerParagraph:
        "We disagreed on timeline due to database tech debt. I proposed a cached polling compromise for Q3 and deferred the real-time pipeline to Q4. This launched 3 days early, kept DB load stable, and saved 40% dev hours.",
    },
    {
      id: 1,
      ...
      icon: Network,
      question:
        "How would you design a real-time notification service (like Slack mobile/browser alerts) at scale?",
      answerParagraph:
        "I would establish open WebSocket connections for active clients, utilizing Redis Pub/Sub routing. Offline messages would push to APNS/FCM. To buffer spikes, messages route through Kafka to worker pools.",
    },
    {
      id: 2,
      ...
      icon: Code2,
      question:
        "Implement a custom debounce function in JavaScript. How does it handle leading/trailing edge calls?",
      answerParagraph:
        "A debounce function returns a closure holding a timeout ID. Each invocation clears active timers via clearTimeout and registers a new setTimeout. The execution context is bound using function.apply.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Parallax speed={0.2} className="absolute -top-20 -right-40">
        <div className="orb orb-peach w-150 h-150 animate-float-orb" />
      </Parallax>
      <Parallax speed={0.4} className="absolute top-1/2 -left-40">
        <div className="orb orb-slate w-100 h-100 animate-float-orb-slow" />
      </Parallax>
      <Parallax speed={0.15} className="absolute -bottom-20 right-1/4">
        <div
          className="orb orb-frost w-87.5 h-87.5 animate-float-orb"
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex-1 flex flex-col justify-between">
        <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-12 items-start my-auto py-6">
          ...
          >
            <h1
              className="font-bold tracking-tight text-slate-900 text-4xl md:text-5xl lg:text-5xl leading-none"
              style={{ fontFamily: "var(--font-display)" }}
            >
              The Invisible Edge in Every{" "}
              <span className="text-gradient-coral">Technical Interview</span>
            </h1>

            <p className="text-base md:text-lg leading-relaxed font-normal text-(--text-muted) max-w-xl">
              Never let your mind go blank. Sits on your desktop, listens to the
              interview, and provides structured response outlines and memory
              prompts in real-time during live sessions.
            </p>
            ...
            <div className="flex flex-col gap-6 mt-4 max-w-xl">
              ...
              <div>
                <Link
                  ...
                  className="btn-primary-glow inline-flex cursor-pointer py-4! px-8! rounded-lg text-base font-semibold"
                >
              ...
              <div className="flex flex-col gap-1.5 pl-1">
                ...
                >
                  <span>
                    🎁 Share with friends: Earn up to 500 bonus credits
                  </span>
              ...
              <div className="border-t border-slate-200/80 pt-5 mt-1 flex flex-col sm:flex-row sm:items-center gap-4 pl-1">
                ...
                <div className="flex items-center gap-5">
                  {[
                    {
                      name: "Google Meet",
                      src: "https://cdn.svgporn.com/logos/google-meet.svg",
                    },
                    {
                      name: "Zoom",
                      src: "https://cdn.svgporn.com/logos/zoom.svg",
                    },
                    {
                      name: "Microsoft Teams",
                      src: "https://cdn.svgporn.com/logos/microsoft-teams.svg",
                    },
                  ].map((plat, i) => (
                    <img
                      key={i}
                ...
                <div className="flex items-center gap-1.5">
                  <div className="flex items-center text-amber-400">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-4.5 h-4.5 fill-current stroke-current"
                      />
                    ))}
                  </div>
                  <span className="text-sm font-extrabold text-(--text-primary)">
                    4.9 / 5 from 180+ beta testers
                  </span>
                </div>
                <div className="text-sm font-medium text-(--text-muted)">
                  Trusted by{" "}
                  <span className="text-(--text-primary) font-extrabold">
                    180+ engineers in beta
                  </span>{" "}
                  across top tech
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute -inset-1 bg-linear-to-br from-(--accent)/5 via-transparent to-slate-200/20 rounded-[22px] -z-10 blur-sm" />
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-(--bg-mist) rounded-lg p-4 border border-(--border-light) flex flex-col gap-3 shadow-2xs h-55 md:h-87.5">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-(--text-secondary)">
                      <MessageSquare className="w-3.5 h-3.5 text-(--accent)" />
                      Question Detected
                    </div>
                    <div className="bg-white p-5 rounded-md border border-slate-200/80 shadow-2xs flex-1 flex items-center justify-center">
                  ...
                  <div className="bg-(--bg-mist) rounded-lg  p-4 border border-(--border-light) flex flex-col gap-4 shadow-2xs h-55 md:h-87.5">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-(--text-secondary)">
                      <Sparkles className="w-3.5 h-3.5 text-(--accent)" />
                      Live AI Answer Stream
                    </div>
                    <div className="bg-white p-4.5 rounded-md border border-slate-200/80 shadow-2xs flex-1 flex flex-col items-start justify-start overflow-hidden">
                      <p className="text-xs md:text-sm font-mono text-(--text-secondary) leading-relaxed text-left">
                        {streamedText}
                        {streamedText.length <
                          currentQ.answerParagraph.length && (
            ...
            <div className="flex w-max gap-12 animate-marquee-infinite items-center">
              ...
              <div className="flex gap-12 items-center shrink-0">
                {companyList.map((comp, idx) => (
                  <div
                    key={`c1-${idx}`}
                    className="group flex items-center justify-center cursor-default select-none shrink-0"
                  >
                    <img
                      src={comp.src}
                      alt={comp.name}
                    ...
                    {comp.showText && (
                      <span
                        className={`text-slate-800 transition-all duration-300 opacity-90 group-hover:opacity-100 ${comp.textClass}`}
                        style={{ fontFamily: "var(--font-display)" }}
                      >
                        {comp.name}
                      </span>
